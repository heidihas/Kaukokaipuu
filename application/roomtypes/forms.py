...
class RoomTypeForm(FlaskForm):
    ...
    price = IntegerField("Price", [validators.NumberRange(message='Value should be between 1 and 1000.', min=1, max=1000)], render_kw={"class":"form-control"})
...
class RoomTypeChangeForm(FlaskForm):
    ...
    price = IntegerField("New price", [validators.NumberRange(message='Value should be between 1 and 1000.', min=1, max=1000)], render_kw={"class":"form-control"})
    many = IntegerField("Rooms/hotel", [validators.NumberRange(message='Value should be at least 1.', min=1)], render_kw={"class":"form-control"})
