...
class RoomTypeForm(FlaskForm):
    ...
    size = IntegerField("Persons", [validators.NumberRange(message='Value should be between 1 and 6.', min=1, max=6)], render_kw={"class":"form-control"})
...
class RoomTypeChangeForm(FlaskForm):
    ...
    size = IntegerField("New persons number", [validators.NumberRange(message='Value should be between 1 and 6.', min=1, max=6)], render_kw={"class":"form-control"})
